...
function render() {
    ...
    var json = {
        'children': [
            {name: 'Lakshadweep', density: 64, literacy: 92.28},
            {name: 'Andaman & Nicobar Island', density: 108, literacy: 86.27},
            {name: 'Sikkim', density: 210, literacy: 82.2},
            {name: 'Chandigarh', density: 19, literacy: 86.4},
            {name: 'Mizoram', density: 282, literacy: 91.58},
            {name: 'Arunachal Pradesh', density: 290, literacy: 66.95},
            {name: 'Goa', density: 100, literacy: 87.4},
            {name: 'Nagaland', density: 141, literacy: 80.11},
            {name: 'Manipur', density: 179, literacy: 79.85},
            {name: 'Meghalaya', density: 448, literacy: 75.48},
            {name: 'Tripura', density: 132, literacy: 87.75},
            {name: 'Himachal Pradesh', density: 263, literacy: 83.78},
            {name: 'Uttarakhand', density: 234, literacy: 79.63},
            {name: 'Jammu & Kashmir', density: 228, literacy: 68.74},
            {name: 'Haryana', density: 88, literacy: 76.64},
            {name: 'Kerala', density: 49, literacy: 93.91},
            {name: 'Punjab', density: 104, literacy: 76.68},
            {name: 'Chattisgarh', density: 199, literacy: 71.04},
            {name: 'Jharkhand', density: 144, literacy: 67.63},
            {name: 'Gujarat', density: 73, literacy: 79.31},
            {name: 'Assam', density: 211, literacy: 73.18},
            {name: 'Odisha', density: 164, literacy: 73.45},
            {name: 'Karnataka', density: 101, literacy: 75.6},
            {name: 'Tamil Nadu', density: 80, literacy: 80.3},
            {name: 'Andhra Pradesh', density: 71, literacy: 67.66},
            {name: 'Bihar', density: 77, literacy: 63.82},
            {name: 'West Bengal', density: 97, literacy: 77.08},
            {name: 'Maharashtra', density: 87, literacy: 82.91},
            {name: 'Rajasthan', density: 157, literacy: 67.06},
            {name: 'Madhya Pradesh', density: 196, literacy: 70.63}
        ]
    }
